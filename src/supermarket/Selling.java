...
public class Selling extends javax.swing.JFrame {
 ...
 public void update()
 {
      try{
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/supermarket","root","");
            String Query = "update pro set qunt="+Qty.getText()+"' Where proid ="+ID;
 ...
 else if(ava< Integer.valueOf(Qty.getText()))
      {   
           JOptionPane.showMessageDialog(this, "nott enough  ");  
       } 
 else{
     i++;
     if(i==1)
        {
           ...
           g=g+ Total;
             BillTxt.setText(BillTxt.getText() + "\t Welcome to SuperMarket\n\t************YOUR BILL*************\n" + " ID    \tNAME    \tPRICE    \tQUANTITY    \tTOTAL\n " + " " + i + "      \t" + Prod.getText() + "      \t" + Price.getText() + "         \t" + Qty.getText() + "      \t" + Total + "\n");
        }
     else 
     { Total= uprice * Integer.valueOf(Qty.getText());
          g=g+ Total;
BillTxt.setText(BillTxt.getText() + " " + i + "      \t" + Prod.getText() + "      \t" + uprice + "         \t" + Qty.getText() + "      \t" + Total + "\n");
     }
     jLabel1.setText("rs="+g);
    //update();
     Prod.setText("");
        Price.setText("");
        Qty.setText("");
...
double ava;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Price.setText(model.getValueAt(tableIndex,3).toString());
        ID = model.getValueAt(tableIndex, 0).toString();
        uprice=Double.valueOf(model.getValueAt(tableIndex,3).toString());
    ava=Double.valueOf(model.getValueAt(tableIndex, 3).toString());
